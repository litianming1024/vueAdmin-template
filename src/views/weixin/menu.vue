<template>
  <div class="app-container">
    <!--代码来自https://github.com/jingjing1117/wechat_menu_set，感谢开源-->
    <div>
              ...
              <el-row class="menulist">
                <el-col v-for="(item,index) in menulist" :key="index" :span="menulist.length<2?12:8" class="menuitem">
                  <a class="pre_menu_link"
                     :style="first_selected===index&&!second_selected?'border:1px solid #44b549':''"
              ...
              <div class="editor_inner">
                <div class="menu_form_hd">
                  <h4 style="float:left;font-weight: 400;margin:0">
                    {{second_selected ? menulist[first_selected].sub_button[second_selected - 1].name :
                    menulist[first_selected].name}}</h4>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: '',
        msgtypelist: [
          { 'name': '文本消息', 'value': 'text' }, { 'name': '图文消息', 'value': 'imgtext' },
          { 'name': '图片', 'value': 'img' },
