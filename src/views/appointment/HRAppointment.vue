  ...
  <div class="app-container calendar-list-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" center fullscreen>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="success" @click="handleChangeApplyStatus(15)">通过</el-button>
        <el-button type="danger" @click="handleChangeApplyStatus(14)">未通过</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      loadData(queryInfo) {
        return appointmentApi.needToInterview(queryInfo, 2, 1).then(response => {
